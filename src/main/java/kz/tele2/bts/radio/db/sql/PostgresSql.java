...
public class PostgresSql {
    public final static String SITE_NAMES = """
            with a as (select distinct site_name as name
                               from radio_data_all
    ...
    public final static String SITES = """
            ...
            select distinct on (name) upper(name) as name, bsc, rnc, operator,
                                      case testing
                                          when 'yes' then 1
                                          when 'no' then 0
                                          end as "isTest",
    ...
    public final static String CELL_NAMES = """
            with w as (select cell_name as cell
                       from radio_data_all
                       where insert_date = (select max(insert_date) from radio_data_all)
                       union
    ...
    public static final String BEELINE_AZIMUTHS = """
            with w as (select case substr(cell_name, length(cell_name) - 1, 1)
                                  when '1' then 'A'
                                  when '2' then 'B'
                                  when '3' then 'C'
                                  when '4' then 'D'
                              ...
                              *
                       from beeline_kcell_250_plus
                       where share_for_tele2 is not null
                         and regexp_like(share_for_tele2, '\\d{4}-\\d{2}-\\d{2} [\\d:]+'))
            select distinct upper(case
                            ...
                            azimuth  as value
            from w where sector is not null
            """;

    public final static String METADATA_KEY_BY_SITE = "select metadata_key from int_metadata_store where region = 'SITE'";
    public final static String METADATA_KEY_BY_CELL = "select metadata_key from int_metadata_store where region = 'CELL'";
    public final static String METADATA_KEY_BY_CELL_INTERFERENCE = "select metadata_key from int_metadata_store where region = 'CELL_INTERFERENCE'";
    public final static String METADATA_KEY_BY_SITE_AZIMUTH = "select metadata_key from int_metadata_store where region = 'SITE_AZIMUTH'";
    public final static String METADATA_KEY_BY_SITE_RO = "select metadata_key from int_metadata_store where region = 'SITE_RO'";
    public final static String METADATA_DELETE_SITE_BY_KEY = "delete from int_metadata_store where metadata_key in (:payload) and region = 'SITE'";
    public final static String METADATA_DELETE_CELL_BY_KEY = "delete from int_metadata_store where metadata_key in (:payload) and region = 'CELL'";
    public final static String METADATA_DELETE_CELL_INTERFERENCE_BY_KEY = "delete from int_metadata_store where metadata_key in (:payload) and region = 'CELL_INTERFERENCE'";
    public final static String METADATA_DELETE_SITE_AZIMUTH_BY_KEY = "delete from int_metadata_store where metadata_key in (:payload) and region = 'SITE_AZIMUTH'";
    public final static String METADATA_DELETE_SITE_RO_BY_KEY = "delete from int_metadata_store where metadata_key in (:payload) and region = 'SITE_RO'";
    public final static String METADATA_KEY_BY_SECTOR_HEIGHT = "select metadata_key from int_metadata_store where region = 'SITE_HEIGHT'";
    public final static String METADATA_DELETE_SECTOR_HEIGHT_BY_KEY = "delete from int_metadata_store where metadata_key in (:payload) and region = 'SITE_HEIGHT'";
    public final static String METADATA_DELETE_SITE_TR_BY_KEY = "delete from int_metadata_store where metadata_key in (:payload) and region = 'SITE_TR'";
    public final static String METADATA_KEY_BY_SITE_WORKS = "select metadata_key from int_metadata_store where region = 'SITE_WORKS'";
    public final static String METADATA_DELETE_SITE_WORKS_BY_KEY = "delete from int_metadata_store where metadata_key in (:payload) and region = 'SITE_WORKS'";
